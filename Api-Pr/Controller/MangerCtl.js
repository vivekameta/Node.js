...
module.exports.loginmangar=async(req,res)=>{
...
module.exports.forgetpassmanager=async(req,res)=>{
  ...
  let user=await MangerModel.findOne({email : req.body.email});
...
module.exports.verifyOtp=async(req,res)=>{
  ...
  if(req.session.otp==otp){
    if(newpass==confirmpass){
      ...
      const newupdatepass=await MangerModel.findByIdAndUpdate(adminId,{password : hashedpass}) 
